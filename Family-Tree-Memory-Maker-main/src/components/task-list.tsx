...
const tasks: Task[] = [
  ...
  { title: "Circular View - Connection lines fix", status: "done", priority: "high" },
  { title: "Person card display preferences (birth/death/nickname/maiden)", status: "done", priority: "high" },
  { title: "Enhanced person cards with pin/unpin", status: "done", priority: "high" },
  { title: "List View - Lineage splitting (maternal/paternal)", status: "done", priority: "high" },
  { title: "List View - Center person pinned at top", status: "done", priority: "high" },
  { title: "List View - Sort order (asc/desc)", status: "done", priority: "medium" },
  { title: "Default center person to first GEDCOM record", status: "done", priority: "high" },
  { title: "Person cards show birth/death locations", status: "done", priority: "medium" },
  { title: "Person cards show occupation", status: "done", priority: "medium" },
  { title: "Second wife button placeholder", status: "done", priority: "low" },
  { title: "Family emblem upload in preferences", status: "done", priority: "low" },
  { title: "Consecutive generation mapping logic", status: "done", priority: "high" },
